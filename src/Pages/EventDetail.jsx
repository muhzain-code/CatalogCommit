...
import { ChevronLeft, Heart, Share2, Calendar, Clock, Users, Tag, Star, Building2 } from "lucide-react"
...
const EventDetail = () => {
  ...
  const mockEventResponse = {
    message: "Success fetch event",
    data: {
      id: 1,
      umkm_id: null,
      umkm: null,
      name: "Pameran UMKM Kreatif",
      description: "Ajang pameran dan temu bisnis produk kreatif dari UMKM.",
      photo: "https://images.unsplash.com/photo-1578426126743-3f553c0baea1?w=600&q=80",
      start_date: "2025-07-22T00:00:00.000000Z",
      end_date: "2025-07-24T00:00:00.000000Z",
      is_active: true,
      is_promo_event: false,
      is_umkm_event: true,
      created_at: "2025-07-13T06:21:57.000000Z",
      updated_at: "2025-07-13T06:21:57.000000Z",
    },
  }

  // Mock API responses for UMKMs - replace with actual API calls
  const mockEventUmkmsResponse = {
    message: "Success fetch UMKMs",
    data: [
      {
        id: 1,
        event_id: 1,
        ...
        umkm: {
          id: 4,
          name: "UMKM A",
          description: "UMKM A description",
          created_at: "2025-07-14T19:01:26.000000Z",
          updated_at: "2025-07-14T19:01:26.000000Z",
        },
        created_at: "2025-07-14T19:01:49.000000Z",
        updated_at: "2025-07-14T19:01:49.000000Z",
      },
      {
        id: 2,
        event_id: 1,
        ...
        umkm: {
          id: 10,
          name: "UMKM B",
          description: "UMKM B description",
          created_at: "2025-07-14T19:01:35.000000Z",
          updated_at: "2025-07-14T19:01:35.000000Z",
        },
        created_at: "2025-07-14T19:01:48.000000Z",
        updated_at: "2025-07-14T19:01:48.000000Z",
      },
    ],
    meta: {
      current_page: 1,
  ...
  // Update the mock API responses section to include product promos
  const mockEventPromosResponse = {
    message: "Success fetch product promos",
    data: [
      {
        id: 8,
        product_id: 14,
        event_id: 1, // Changed to match our event ID
        promo_price: "122252.08",
        is_active: true,
        product: {
          id: 14,
          umkm_id: 4,
          category_id: 7,
          name: "Cokelat Bubuk Jawa",
          description: "Delectus et odit repellat inventore.",
          price: "140519.63",
          status: "available",
          created_by: null,
          updated_by: null,
      ...
      },
      {
        ...
        product: {
          ...
          description: "Suscipit alias culpa est occaecati at sapiente dignissimos.",
          price: "105963.08",
          status: "available",
          created_by: null,
          updated_by: null,
      ...
      },
      {
        ...
        product_id: 21,
        event_id: 1, // Changed to match our event ID
        promo_price: "60883.86",
        is_active: true,
        product: {
          id: 21,
          umkm_id: 8,
          category_id: 13,
          name: "Sandal Anyaman Pandan",
          description: "Voluptatem debitis sequi atque deserunt.",
          price: "74248.61",
          status: "pre_order",
          created_by: null,
          updated_by: null,
          created_at: "2025-07-14T19:01:29.000000Z",
          updated_at: "2025-07-14T19:01:29.000000Z",
          deleted_at: null,
        },
        created_at: "2025-07-14T19:01:48.000000Z",
        updated_at: "2025-07-14T19:01:48.000000Z",
      },
      {
        ...
        product: {
          ...
          description: "Ullam sunt et vero aut.",
          price: "140100.43",
          status: "available",
          created_by: null,
          updated_by: null,
          created_at: "2025-07-14T19:01:36.000000Z",
          updated_at: "2025-07-14T19:01:36.000000Z",
          deleted_at: null,
        },
        created_at: "2025-07-14T19:01:47.000000Z",
        updated_at: "2025-07-14T19:01:47.000000Z",
      },
    ],
    meta: {
      current_page: 1,
  ...
  useEffect(() => {
    const fetchEventData = async () => {
      try {
        ...
        setEventData(mockEventResponse.data)

        // Filter UMKMs for this specific event
        const filteredUmkms = mockEventUmkmsResponse.data.filter((item) => item.event_id === mockEventResponse.data.id)
        ...
        if (mockEventResponse.data.is_promo_event) {
          const filteredPromos = mockEventPromosResponse.data.filter(
            (item) => item.event_id === mockEventResponse.data.id,
          )
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 py-4 border-t border-b border-gray-200">
              <div className="text-center">
                <div className="text-2xl font-bold text-gray-900">ID-{eventData.id}</div>
                <div className="text-sm text-gray-600">ID Event</div>
              </div>
              <div className="text-center">
                  ...
                  <div className="p-6">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-900 text-sm">{item.umkm.name}</h3>
                        <p className="text-xs text-gray-500">ID: {item.umkm.id}</p>
                      </div>
                    </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        {/* Product Description */}
                        <p className="text-xs text-gray-600 mb-3 line-clamp-2">{promo.product.description}</p>
                        ...
                        <div className="space-y-2">
                          <button
                            ...
                            disabled={promo.product.status === "inactive"}
                          >
                            {promo.product.status === "available"
                              ? "Beli Sekarang"
                              : promo.product.status === "pre_order"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="border-l-4 border-red-500 pl-4">
                  ...
                  <p className="text-gray-600">
                    Event ini {eventStatus.toLowerCase()} dan{" "}
                    {eventData.is_active ? "masih aktif" : "sudah tidak aktif"}
                  </p>
                </div>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600">
                    {eventData.is_umkm_event ? "Event khusus untuk UMKM terdaftar" : "Event terbuka untuk umum"}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-gray-600">Informasi lokasi akan diumumkan kemudian</p>
                </div>

                <div className="border-l-4 border-yellow-500 pl-4">
                  <h3 className="font-semibold text-gray-900">Kontak</h3>
                  <p className="text-gray-600">Hubungi penyelenggara untuk informasi lebih lanjut</p>
                </div>
              </div>
            </div>
          </div>
